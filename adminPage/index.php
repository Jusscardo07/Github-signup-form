...
$select = mysqli_query($conn,"SELECT * FROM products");
    ...
    <div class="product-display">
     ...
     <?php while ($row = mysqli_fetch_assoc($select)){ 
       ?>   
        <tr>
         <td><img src="img/<?php echo $row['image']; ?>" height="100"></td>  
         <td><?php echo $row['name'];?></td>
         <td>R<?php echo $row['price'];?>/-</td>   
         <td>
            <a href="admin_update.php?edit=<?php echo $row['id']; ?>" class="btn"> <i class='bx bxs-edit'></i> edit</a>
            <a href="index.php?delete=<?php echo $row['id']; ?>" class="btn"> <i class='bx bxs-trash-alt'></i> delete</a>
         </td>
          </tr>     
     <?php }; ?>
        </table>
