...
if($image_01_size > 2000000 || $image_02_size > 2000000 
...
placeholder="enter your product name" class="box" maxlength="100" required>
</div>
<div class="inputBox">
<span>product price (required)</span>
<input type="number" name="price" min="0"
placeholder="enter product price" class="box" maxlength="999999999"  
...
class="box" accept="image/jpg, image/jpeg, image/png, image/webp" required>
</div>
