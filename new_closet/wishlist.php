...
$message[] = 'wishlist deleted successfuly!';
}
...
onclick="return confirm('delete this item from wishlist?');" name="delete" class="delete-btn">
</form>
<?php 
}
}else {
...
<p>grand total: <span>R<?=$grand_total;?> </span>
<a href="shop.php" class="option-btn">continue shopping</a>
<a href="wishlist.php?delete_all" class="delete-btn <?=($grand_total > 1)?'':'disabled'; ?>" 
onclick="return confirm('delete all items from your wishlist?');">delete_all</a>
</div>

</section>

<!---wishlist cart section ends --->
